...
import googleStore from "../assets/img/google-play-badge.svg";
import demoScreen from "../assets/img/demo-screen.mp4";
import tnw from "../assets/img/tnw-logo.svg";
function Dashboard() {
        ...
        <div className="container px-5">
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ms-auto me-4 my-3 my-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link me-lg-3" href="#feedback">
                  Send Feedback
                </a>
              </li>
            </ul>
            ...
            <div className="col-lg-6">
              ...
              <div className="mb-5 mb-lg-0 text-center text-lg-start">
                ...
                <p className="lead fw-normal text-muted mb-5">
                  Launch your mobile app landing page
                </p>
                <div className="d-flex flex-column flex-lg-row align-items-center">
                  <a className="me-lg-3 mb-4 mb-lg-0" href="#!">
                    <img className="app-badge" src={googleStore} alt="..." />
                  </a>
                  <a href="#!">
                    <img className="app-badge" src={appStore} alt="..." />
                  </a>
                </div>
              </div>
            </div>
        ...
        <div className="container px-5">
          <div className="row gx-5 justify-content-center">
            <div className="col-xl-8">
              ...
              <img src={tnw} alt="..." style={{ height: "3rem" }} />
            </div>
          </div>
        </div>
      </aside>
